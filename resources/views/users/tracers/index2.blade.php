            ...
            <div class="col-lg-9">
                ...
                <form>
                    <div class="card mb-3">
                        <div class="card-body">
                            <!-- Form Group -->
                            <label for="formLabel1" class="form-label">Pertanyaan Yes No</label>
                            ...
                            <div class="row">
                                <div class="col-sm mb-2 mb-sm-0">
                                    ...
                                    <label class="form-control" for="formControlRadioEg11">
                                        <span class="form-check">
                                            <input type="radio" class="form-check-input" name="a1" value="ya" id="formControlRadioEg11">
                                ...
                                <div class="col-sm mb-2 mb-sm-0">
                                    ...
                                    <label class="form-control" for="formControlRadioEg21">
                                        <span class="form-check">
                                            <input type="radio" class="form-check-input" name="a1" value="tidak" id="formControlRadioEg21">
                    ...
                    <div class="card ms-10 mb-3">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <label for="formLabel" class="col-lg-3 col-form-label form-label">Rate</label>
                                    ...
                                    <div class="input-group input-group-sm-vertical">
                                        ...
                                        <label class="form-control" for="formControlRadioEg1">
                                            <span class="form-check m-auto">
                                                <input type="radio" class="form-check-input" name="aa1" id="formControlRadioEg1" value="1">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <!-- Form Group -->
                            <label for="formLabelRadio" class="form-label">Pertanyaan Radio</label>

                            <div class="mb-3">
                                <!-- Form Radio -->
                                <label class="form-control" for="formControlRadio2Eg1">
                                    <span class="form-check">
                                        <input type="radio" class="form-check-input" name="aa2" value="Rumah sendiri/bersama orang tua" id="formControlRadio2Eg1">
                            ...
                            <div class="mb-3">
                                <!-- Form Radio -->
                                <label class="form-control" for="formControlRadio2Eg2">
                                    <span class="form-check">
                                        <input type="radio" class="form-check-input" name="aa2" value="Kos" id="formControlRadio2Eg2">
                            ...
                            <div class="mb-3">
                                <!-- Form Radio -->
                                <label class="form-control" for="formControlRadio2Eg3">
                                    <span class="form-check">
                                        <input type="radio" class="form-check-input" name="aa2" value="Pondok Pesantren" id="formControlRadio2Eg3">
                            ...
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0">
                                    <!-- Form Radio -->
                                    <label class="form-control" for="formControlRadio2Eg4">
                                        <span class="form-check">
                                            <input type="radio" class="form-check-input" name="aa2" id="formControlRadio2Eg4">
                                            <span class="form-check-label">Lainnya</span>
                                        </span>
                                    </label>
                                </div>
                                <div class="flex-grow-1">
                                    <input type="text" class="form-control form-control-borderless form-control-flush border-bottom" name="" placeholder="Isi jika memilih lainnya...">
                                </div>
                                <!-- End Form Radio -->
                            </div>
                        </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="form-control" name="string" id="formLabelString1" placeholder="Jawaban Anda...">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" id="formCheck111" class="form-check-input" value="Multiple 1">
                            ...
                            <div class="mb-3">
                                <!-- Form Checkbox -->
                                <div class="form-check mb-3">
                                    <input type="checkbox" id="formCheck121" class="form-check-input" value="Multiple 2">
                            ...
                            <div class="mb-3">
                                <!-- Form Checkbox -->
                                <div class="form-check mb-3">
                                    <input type="checkbox" id="formCheck131" class="form-check-input" value="Multiple 3">
                            ...
                            <div class="mb-3">
                                <!-- Form Checkbox -->
                                <div class="form-check mb-3">
                                    <input type="checkbox" id="formCheck141" class="form-check-input" value="Multiple 4">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="flex-grow-1">
                                    <input type="text" class="form-control form-control-sm form-control-borderless form-control-flush border-bottom" name="1" placeholder="Isi jika memilih lainnya...">
                                </div>
                                <!-- End Form Checkbox -->
                            </div>
                        </div>
