    ...
    <div class="content container">
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Tracer Study</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Detail</li>
                        </ol>
                    </nav>

                    <h1 class="page-header-title">Detail Tracer Study</h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title h4">Detail Tracer Study</h2>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end">
                    <a href="/admin/report/tracer-study" class="btn btn-white">Kembali</a>
                </div>
            </div>
            <!-- End Body -->
        </div>
